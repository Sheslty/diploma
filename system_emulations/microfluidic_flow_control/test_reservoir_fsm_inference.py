...
def main():
    ...
    learned_model = run_non_det_Lstar(alphabet=alphabet, sul=sul,
                                      eq_oracle=eq_oracle)
    learned_model.save(PATH_TO_RESULTS_DIR + "Microfluidic_non_det_L")
    ...
    learned_model = run_Lstar(alphabet=alphabet, sul=sul, eq_oracle=eq_oracle,
                              automaton_type='dfa')
    learned_model.save(PATH_TO_RESULTS_DIR + "Microfluidic_L_dfa")
    ...
    learned_model.save(PATH_TO_RESULTS_DIR + "Microfluidic_L_moore")
    ...
    learned_model.save(PATH_TO_RESULTS_DIR + "Microfluidic_L_mealy")
